...
summary(fit.1)
```
Il ne reste pas une tendence. La séries est-elle stationnaire ?
...
$$(1-B)(1-B^{12}) \log(X_t) = \varepsilon_t $$
...
# summary(fit.12.1)
```
Dans l'ACF il y a encore quelques bâtons qui sortent: à 1, 2 et 12 mois.
