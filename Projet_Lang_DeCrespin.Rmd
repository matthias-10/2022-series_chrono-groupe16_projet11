...
#### ARMA minimal par la mèthode de coins
...
ARMA(1,1) ou ARMA(1,3) au maximum, ou ARIMA(1,2). Pour un SARIMA((p,1,q),(P,1,Q))[12] on peut pas puiser les nombre d'estimateur pour D et Q de ce graphique. Mais il semble comme s'il y a un saisonnalité pour Q.
