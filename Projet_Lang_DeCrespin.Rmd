...
Alors on aurait la modèle suivante, avec $\epsilon_t$ supposé b.b.:

$$(1-B)(1-B^{12}) \log(X_t) = (1-\theta_1B)(1-\theta_{12}B^{12})\epsilon_t$$
Autrement dit, une $\text{SARIMA}_12[(p= 0,d= 0,q= 1),(P= 0,D= 1,Q= 1)]$

```{r fitting a model}
model1 <- arima(miles, order = c(0,0,1), seasonal=list(order = c(0,1,1), perdiod=12))
