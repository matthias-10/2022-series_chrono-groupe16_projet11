...
acf(mdiff12diff1, lag.max = 60, ci.type = "ma")
pacf(mdiff12diff1, lag.max = 60)
```
La chute des valeurs vers 0 de $\hat\rho$ indique un modèle MA(q). On suppose que le bâton qui sort avec un decalage de 12 est dû au hasard.
On voit dans le diagramme PACF 
